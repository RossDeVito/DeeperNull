...
* --null-dir: Directory containing the null model predictions. Default:
	'/rdevito/deep_null/dn_output/V4_w_save_bin_cls'
...
WORKFLOW_ID = 'workflow-J09Vk8jJv7B2Bbppzxykyb52'
DEFAULT_INSTANCE = 'mem1_ssd1_v2_x72'

N_SAMP_PHENO = {
	"asthma_42015": 254008,
	"depression_20438": 254008,
	"diabetes_2443": 253916,
}
...
def parse_args():
	...
	parser.add_argument(
		'--null-dir',
		default='/rdevito/deep_null/dn_output/V4_w_save_bin_cls',
