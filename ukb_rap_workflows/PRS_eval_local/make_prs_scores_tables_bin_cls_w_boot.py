...
def retrieve_scores_for_pheno(model_type, pheno,
	...
	all_scores = get_scores_dict(
		scores_json_path=f"{model_out_dir}/scores_w_bootstrap_100000.json",
		local_json_path=local_json_path
	)

	if all_scores is None:
		# Not found or invalid
		return (None, None, None, True, model_type, pheno)
	...
	return (val_dict, test_dict, boot_dict, False, model_type, pheno)
...
if __name__ == "__main__":
	...
	model_dirs = {
		...
		"basil_age_sex_pc_null_xgb_3_bin_cls_age_sex_lasso_25": "/rdevito/deep_null/output/PRS_BASIL/{:}/age_sex_pc_null_xgb_3_bin_cls_age_sex_lasso_25",
		"basil_age_sex_all_coords_pc_null_xgb_3_bin_cls_age_sex_all_coords_lasso_25": "/rdevito/deep_null/output/PRS_BASIL/{:}/age_sex_all_coords_pc_null_xgb_3_bin_cls_age_sex_all_coords_lasso_25",
		"basil_age_sex_time_pc_null_xgb_3_bin_cls_age_sex_time_lasso_25": "/rdevito/deep_null/output/PRS_BASIL/{:}/age_sex_time_pc_null_xgb_3_bin_cls_age_sex_time_lasso_25",
		"basil_age_sex_all_coords_time_pc_null_xgb_3_bin_cls_age_sex_all_coords_time_lasso_25": "/rdevito/deep_null/output/PRS_BASIL/{:}/age_sex_all_coords_time_pc_null_xgb_3_bin_cls_age_sex_all_coords_time_lasso_25",
		"basil_age_sex_all_coords_time_pc_null_xgb_3_bin_cls_age_sex_all_coords_time_pc_lasso_25": "/rdevito/deep_null/output/PRS_BASIL/{:}/age_sex_all_coords_time_pc_null_xgb_3_bin_cls_age_sex_all_coords_time_pc_lasso_25",
	}
	...
	for val_dict, test_dict, boot_dict, was_missing, model_type, pheno in results:
		if was_missing:
			missing_info.append({
			...
			boot_scores.append(boot_dict)

	# Convert to DataFrames
	val_scores_df = pd.DataFrame(val_scores)
	test_scores_df = pd.DataFrame(test_scores)
	missing_df = pd.DataFrame(missing_info)
	boot_scores_df = pd.DataFrame(boot_scores)
	...
	boot_scores_df.to_csv(os.path.join(save_dir, "test_boot_scores_bin_cls.csv"), index=False)